	...
	if (SDL_Init(SDL_INIT_EVERYTHING) == 0) {
		...
		if (window != 0) //window init success
		{
			...
			if (renderer != 0) //renderer init success
			{
				...
				TextureManager::Instance()->loadTexture("assets/cat1.jpg", "cat1", renderer);
				TextureManager::Instance()->loadTexture("assets/cat2.jpg", "cat2", renderer);
				TextureManager::Instance()->loadTexture("assets/dog1.jpg", "dog1", renderer);
				TextureManager::Instance()->loadTexture("assets/dog2.jpg", "dog2", renderer);
...
void Game::render() {
	...
	{
		if (showImage) {
			TextureManager::Instance()->drawTexture("cat1", { 0,0,ww / 2, wh / 2 }, renderer);
		}
		else
		{
	...
	{
		if (showImage) {
			TextureManager::Instance()->drawTexture("dog1", { ww/2,0,ww / 2, wh / 2 }, renderer);
		}
		else
		{
	...
	{
		if (showImage) {
			TextureManager::Instance()->drawTexture("cat2", { 0,360,640, 360 }, renderer);
		}
		else
		{
	...
	else if (isInFourthQuadrant)
	{
		if (showImage)
		{
			TextureManager::Instance()->drawTexture("dog2", { 640,360,640, 360 }, renderer);
		}
		else
		{
